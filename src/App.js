...
function App() {
    return (
<div class="h-screen w-full bg-black relative flex overflow-hidden">
  ...
  <div class="w-full h-full flex flex-col justify-between">
    <header class="h-16 w-full flex items-center relative justify-end px-5 space-x-10 bg-gray-800">
      <div class="flex flex-shrink-0 items-center space-x-4 text-white">
        ...
        <div class="flex flex-col items-end ">
          <div class="text-md font-medium ">Gadjah Mada Aerospace Team</div>
          <div class="text-sm font-regular">Tamara Sashikirana</div>
        </div>
    ...
    <main class="max-w-full h-full flex relative overflow-y-hidden">
      <div class="h-full w-full m-4 flex flex-wrap items-start justify-start rounded-tl grid-flow-col auto-cols-max gap-4 overflow-y-scroll">
        ...
        <div class="w-96 h-60 rounded-lg flex-shrink-0 flex-grow"></div>
        <div class="w-96 h-60 rounded-lg flex-shrink-0 flex-grow"></div>
        <div class="w-96 h-60 rounded-lg flex-shrink-0 flex-grow"></div>
        <div class="w-96 h-60 rounded-lg flex-shrink-0 flex-grow"></div>
        <div class="w-96 h-60 rounded-lg flex-shrink-0 flex-grow"></div>
